...
run_case "ui_app"        "$OUT/ui_app"        "$IUI/app.cb"                   -i "$IUI"
run_case "ui_counter"    "$OUT/ui_counter"    "$IUI/counter.cb"               -i "$IUI"
run_case "ui_counter_jsx" "$OUT/ui_counter_jsx" "$IUI/counter_jsx.cb"         -i "$IUI"
